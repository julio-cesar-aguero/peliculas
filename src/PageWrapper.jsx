      ...
      <header className="ht-header">
        <div className="container">
            ...
            >
              <ul className="nav navbar-nav flex-child-menu menu-left">
                ...
                <li className="dropdown first">
                  ...
                  <ul className="dropdown-menu level1">
                    <li>
                      <a href="celebr//itygrid01.html">celebr//ity grid 01</a>
                    </li>
                    <li>
                      <a href="celebr//itygrid02.html">celebr//ity grid 02 </a>
                    </li>
                    <li>
                      <a href="celebr//itylist.html">celebr//ity list</a>
                    </li>
                    <li className="it-last">
                      <a href="celebr//itysingle.html">celebr//ity single</a>
                    </li>
                  </ul>
                </li>
                <li className="dropdown first">
          ...
          <div className="top-search">
            ...
            <input
              type="text"
              placeholder="Search for a movie, TV Show or celebr//ity that you are looking for"
            />
          </div>
        </div>
      </header>
